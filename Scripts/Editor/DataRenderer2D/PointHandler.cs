...
namespace NodeEditor.DataRenderer2D.Editors
{
    public class PointHandler
    {
        ...
        void HandleNextControlPoint(int idx, SerializedProperty node)
        {
        ...
        void HandlePrevControlPoint(int n, SerializedProperty node)
        {
            var pos = _owner.transform.TransformPoint(node.FindPropertyRelative("position").vector3Value);
        ...
        void HandleOffset(int n, SerializedProperty offset, Vector3 position)
        {
        ...
        void HandlePoint(int n, SerializedProperty position)
        {
            EditorGUI.BeginChangeCheck();
        ...
        void HandlesAddPointButton()
        {
            ...
            if (
                Handles.Button(
                    _owner.transform.TransformPoint(last + direction * m_distanceBuffer),
